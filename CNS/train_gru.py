...
content_path = '..'
model_save_path = content_path + '/model/gru.pth'
...
model = GRUModel(256,512,256,1,0.2).to(device)
RNN_flag = True
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.title('Training and Test Loss over Epochs of GRU ')
plt.legend()

# Save the plot
plt.savefig('results/loss_curve_gru.png')
